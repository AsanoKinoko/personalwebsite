...
A responsive personal portfolio website showcasing projects, blog posts, and professional information.
...
Trang web portfolio cá nhân responsive giới thiệu các dự án, bài viết blog và thông tin chuyên nghiệp.
...
Chỉ cần mở `index.html` trong trình duyệt web. Không cần quá trình build.

## Author | Tác Giả

**Kyuumei Neko** - Intern Developer
